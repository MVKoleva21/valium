...
export default function Wills() {
    return (
        <div className="flex flex-col items-center justify-center w-screen h-screen bg-[#0B0B0F] text-white">
            <div className="text-5xl font-black mb-6">My digital will</div>
            <p className="text-base font-normal mb-6">Choose between the three types of will, or more than one</p>

            <div className="flex space-x-7 mb-10">
                <div className="flex-auto max-w-xs bg-zinc-900 p-4 rounded-lg">
